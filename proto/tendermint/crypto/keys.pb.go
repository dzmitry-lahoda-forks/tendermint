...
type PublicKey_Bn256 struct {
	Bn256 []byte `protobuf:"bytes,4,opt,name=bn256,proto3,oneof" json:"bn256,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()   {}
func (*PublicKey_Secp256K1) isPublicKey_Sum() {}
func (*PublicKey_Sr25519) isPublicKey_Sum()   {}
func (*PublicKey_Bn256) isPublicKey_Sum()     {}
...
func (m *PublicKey) GetBn256() []byte {
	if x, ok := m.GetSum().(*PublicKey_Bn256); ok {
		return x.Bn256
	}
	return nil
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0xb1, 0x26, 0xe5, 0x19, 0x99, 0x9a, 0x49, 0xb0, 0x40, 0x65, 0x20, 0x5c, 0x2b, 0x8e, 0x17, 0x0b,
	...
	0x36, 0xb0, 0x84, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x51, 0xc1, 0x8d, 0x82, 0x32, 0x01, 0x00,
	0x00,
}
...
func (this *PublicKey_Bn256) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_Bn256)
	if !ok {
		that2, ok := that.(PublicKey_Bn256)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.Bn256, that1.Bn256); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_Bn256) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.Bn256, that1.Bn256) {
		return false
	}
	return true
}
...
func (m *PublicKey_Bn256) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_Bn256) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Bn256 != nil {
		i -= len(m.Bn256)
		copy(dAtA[i:], m.Bn256)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.Bn256)))
		i--
		dAtA[i] = 0x22
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_Bn256) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Bn256", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
